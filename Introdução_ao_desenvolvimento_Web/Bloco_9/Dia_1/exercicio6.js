...
const messageDelay = () => Math.floor(Math.random() * 6000);
...
const sendMarsTemperature = () => {
  const atualyTemperature = getMarsTemperature();
  setTimeout(
    () => console.log(`Mars temperature is: ${atualyTemperature} degree Celsius`),
    messageDelay(),
  );
